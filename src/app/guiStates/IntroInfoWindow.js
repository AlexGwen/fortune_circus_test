...
export class IntroInfoWindow extends WindowsBase {
    ...
    _updateGameSize() {
        ...
        if (this._fx) {
            const scaleX = OMY.Omy.WIDTH/this._fx.width;
            const scaleY = OMY.Omy.HEIGHT/this._fx.height;
            if(scaleX>1) {
                const scale = this._fx.scaleX + scaleX-1;
                this._fx.scale.set(scale);
            }
            // console.warn(OMY.Omy.WIDTH,OMY.Omy.HEIGHT);
        }
        // if (this._bg1) {
        //     this._bg1.x = -this.x;
        //     this._bg1.y = -this.y;
    ...
    _createGraphic() {
        ...
        this._fx = this.getChildByName("s_help_fx");
