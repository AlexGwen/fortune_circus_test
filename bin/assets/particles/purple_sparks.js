// d90b4462-d9f7-4896-b3d7-2ff38ff842e0
...
function NeutrinoEffect(ctx) {
	...
	this.textures = ['blurable_spot.png'];
	this.materials = [1];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]}];
	this.Xe = 300;

	function Emitter_purple_sparks_up() {

		var _1, _2 = [], _2i, _2s = [], _3 = [], _5, _6 = [], _6i0, _6s0 = [], _6i1, _6s1 = [], _6i2, _6s2 = [], _8 = [], _9=[], _9fs=[], _9vs=[], _9rw=[], _9rwn=[], _9rwl, _9v=[], _9p=[], _9dtl, _9dtp, _9df, _9fsd=[], _11=[], _11x=[], _11y=[], _11z=[], _12 = [], _10, _13, _14 = [], _14i0, _14s0 = [], _14i1, _14s1 = [], _15, _16, _16i0, _16s0 = [], _17, _17i0, _17s0 = [];
		this.pe = [{xe:1,Rc:8,Sc:1,renderStyleIndex:0}];
		this.name = "purple_sparks_up";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[-355.52,-482.88],[347.6,-482.64],[347.6,-482.64]]
			];
			Bd._6 = [
				[
					[0,0,0]
		...
		this.fd = function(Bd, Xb) {
			...
			ctx.V(_6s0,0,(_6i0-0)*1);
			_6i1=(_5<0?0:(_5>1?1:_5));
			ctx.V(_6s1,0,(_6i1-0)*1);
			_6i2=(_5<0?0:(_5>1?1:_5));
			ctx.V(_6s2,0,(_6i2-0)*1);
			ctx.W(_6, Db.nb(Bd._6[0][_6s0[0]],_6s0[1]),Db.nb(Bd._6[1][_6s1[0]],_6s1[1]),Db.nb(Bd._6[2][_6s2[0]],_6s2[1]));
			Xb._7 = [];
			ctx.T(Xb._7, _6);
			ctx.T(Xb.Ab, Xb._4);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			ctx.T(Xb.Ab, Xb._4);
			ctx.Q(_11z, [0,0,1]);
			ctx.I(_11y, _11z, Xb._7);
			ctx.Q(_11y, _11y);
			ctx.I(_11x, _11y, _11z);
			ctx.pb(_11, _11x, _11y, _11z);
			ctx.V(_12, 60, 20);
			_10 = 3;
			_13 = (Xb._ / _10);
			...
			ctx.V(_14, Db.nb(Bd._14[0][_14s0[0]],_14s0[1]),Db.nb(Bd._14[1][_14s1[0]],_14s1[1]));
			_15 = ctx.j(_12, _14);
			_16i0=(_13<0?0:(_13>1.3?1.3:_13));
			ctx.V(_16s0,0,(_16i0-0)*0.769231);
			_16 = Db.nb(Bd._16[0][_16s0[0]],_16s0[1]);
			_17i0=(_13<0?0:(_13>1?(0+((_13-0)%1)):_13));
			ctx.V(_17s0,0,(_17i0-0)*1);
			_17 = Db.nb(Bd._17[0][_17s0[0]],_17s0[1]);
			ctx.S(Xb.Pd,[0.5,0.5]);
			ctx.U(Xb.Mc, _11);
			ctx.S(Xb.Nd,_15);
			ctx.T(Xb.gf,[0.81,0.27,1]);
			Xb.Od = _16;
			Xb.Qc = (_17 < 0) ? 0 : ((_17 >= 8) ? 7 : _17);
		}
	...
	function Emitter_purple_sparks_right() {

		var _1, _2 = [], _2i, _2s = [], _3 = [], _5, _6 = [], _6i0, _6s0 = [], _6i1, _6s1 = [], _6i2, _6s2 = [], _8 = [], _9=[], _9fs=[], _9vs=[], _9rw=[], _9rwn=[], _9rwl, _9v=[], _9p=[], _9dtl, _9dtp, _9df, _9fsd=[], _11=[], _11x=[], _11y=[], _11z=[], _12 = [], _10, _13, _14 = [], _14i0, _14s0 = [], _14i1, _14s1 = [], _15, _16, _16i0, _16s0 = [], _17, _17i0, _17s0 = [];
		this.pe = [{xe:1,Rc:8,Sc:1,renderStyleIndex:0}];
		this.name = "purple_sparks_right";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[377.44,62.88],[373.52,-587.76],[373.52,-587.76]]
			];
			Bd._6 = [
				[
					[0,200,200]
		...
		this.fd = function(Bd, Xb) {
			...
			ctx.c(Xb._4, Bd.Ab, _3);
			_5 = 0 + Bd.Ld.rand() * (1 - 0);
			_6i0=(_5<0?0:(_5>1.02788?1.02788:_5));
			ctx.V(_6s0,0,(_6i0-0)*0.972874);
			_6i1=(_5<0?0:(_5>1?1:_5));
			ctx.V(_6s1,0,(_6i1-0)*1);
			_6i2=(_5<0?0:(_5>1?1:_5));
			ctx.V(_6s2,0,(_6i2-0)*1);
	...
	function Emitter_purple_sparks_left() {

		var _1, _2 = [], _2i, _2s = [], _3 = [], _5, _6 = [], _6i0, _6s0 = [], _6i1, _6s1 = [], _6i2, _6s2 = [], _8 = [], _9=[], _9fs=[], _9vs=[], _9rw=[], _9rwn=[], _9rwl, _9v=[], _9p=[], _9dtl, _9dtp, _9df, _9fsd=[], _11=[], _11x=[], _11y=[], _11z=[], _12 = [], _10, _13, _14 = [], _14i0, _14s0 = [], _14i1, _14s1 = [], _15, _16, _16i0, _16s0 = [], _17, _17i0, _17s0 = [];
		this.pe = [{xe:1,Rc:8,Sc:1,renderStyleIndex:0}];
		this.name = "purple_sparks_left";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._2 = [
				[[-367.04,62.88],[-370.96,-587.76],[-370.96,-587.76]]
			];
			Bd._6 = [
				[
					[-52.3446,-200,-200]
	...
	this.qd = function(Ld) {
		...
		Ld.pd(new Emitter_purple_sparks_up());
		Ld.pd(new Emitter_purple_sparks_right());
		Ld.pd(new Emitter_purple_sparks_left());
	}
