// bbea491c-be0d-4fb7-9dda-137f424015ee
...
function NeutrinoEffect(ctx) {
	...
	this.textures = ['3eaa499f3a7f941bdb5137547eab7373.jpg'];
	this.materials = [1];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]}];
	this.Xe = 100;

	function Emitter_Purple() {

		var _1, _2, _3, _4 = [], _6 = [], _9, _11=[], _12, _14, _13, _15, _16, _16i0, _16s0 = [];
		this.pe = [{xe:0,Rc:4,Sc:4,renderStyleIndex:0}];
		this.name = "Purple";
		...
		this.ud = function(Bd) {
			...
			Bd._16 = [
				[
					[0,0.00402761,0.0143325,0.0313219,0.055229,0.0859636,0.12292,0.16479,0.209484,0.254287,0.296277,0.332861,0.362182,0.38324,0.395766,0.4,0.4],
					[0.4,0.396418,0.385018,0.365749,0.338904,0.305237,0.266057,0.22323,0.179057,0.136017,0.0964576,0.0623257,0.0350156,0.0153562,0.00369116,0,0]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
		...
		this.fd = function(Bd, Xb) {
			Xb._ = 0.0;
			_1 = -700 + Bd.Ld.rand() * (700 - -700);
			_2 = -700 + Bd.Ld.rand() * (700 - -700);
			_3 = -200 + Bd.Ld.rand() * (200 - -200);
			ctx.W(_4, _1, _2, _3);
			Xb._5 = [];
			ctx.c(Xb._5, Bd.Ab, _4);
			ctx.randv3gen(_6, 20, Bd.Ld.rand);
			Xb._7 = [];
			ctx.T(Xb._7, _6);
			Xb._8 = 0;
			_9 = 0 + Bd.Ld.rand() * (16 - 0);
			Xb._10 = _9;
			ctx.T(Xb.Ab, Xb._5);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_16i0<0.5?ctx.V(_16s0,0,(_16i0-0)*30):ctx.V(_16s0,1,(_16i0-0.5)*30);
			_16 = Db.nb(Bd._16[0][_16s0[0]],_16s0[1]);
			ctx.S(Xb.Pd,[0.5,0.5]);
			Xb.Md = Xb._8;
			ctx.V(Xb.Nd,_14,_14);
			ctx.T(Xb.gf,[0.56,0.03,1]);
			Xb.Od = _16;
			Xb.Qc = (Xb._10 < 0) ? 0 : ((Xb._10 >= 16) ? 15 : Xb._10);
		}
